...
serpApi_Key='bdd6b29a70304692f428205cd05b87bb383939651710a6ab1bc7d01d01914fc0'
            ...
            if received_value == '1':
                ...
                try: 
                    ...
                    params = {
                            "engine": "google_news",
                            "q": search_query,
                            "api_key": "bdd6b29a70304692f428205cd05b87bb383939651710a6ab1bc7d01d01914fc0"
                            }
                    search = GoogleSearch(params)
                    results = search.get_dict()
                    search_res = results["news_results"][:10]
                    concatenated_titles = "\n".join([f"{index + 1}. {news['title']}" for index, news in enumerate(search_res)])
                    ...
                    print("News search result is:", concatenated_titles)
